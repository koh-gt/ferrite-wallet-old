 ...
 */
 ...
 public final class EditAddressBookEntryFragment extends DialogFragment
 {
	 ...
	 private Address address; // Declare address as a member variable
	 ...
	 public Dialog onCreateDialog(final Bundle savedInstanceState)
	 {
		 ...
		 try {
			 // Initialize the class member address
			 address = Address.fromBase58(Constants.NETWORK_PARAMETERS, args.getString(KEY_ADDRESS));
		 } catch (Exception e) {
			 e.printStackTrace();
		 }
